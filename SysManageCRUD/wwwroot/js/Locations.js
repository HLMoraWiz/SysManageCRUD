...
function cargarDatatable() {
    datatable = $("#tblLocations").DataTable({
        "ajax": {
        ...
        "responsive": true,
        "columns": [
            { "data": "idLocation","width": "10%" },
            { "data": "hospitalName", "width": "15%" },
            { "data": "address", "width": "15%" },
            {
                ...
                "render": function (data) {
                    return `
                      ...
                      <a href="/admin/location/edit/${data}" class="btn btn-success  text-white" style="cursor:pointer; width:100px"">
